...
import TeamCompetitionCard from './OffstageJudgesCard'
import TeamCompetitionCardSkeleton from './OffstageJudgesCardSkeleton'
import PaginationControls from '@/components/PaginationControls'
import useTeamCompetitions, {
  Competition,
} from '../-hooks/useOffstageJudges'
import { Route } from '..'
import CompetitionStatus from '@/constants/CompetitionStatus'
import useOffstageJudges from '../-hooks/useOffstageJudges'
import OffstageJudgesCard from './OffstageJudgesCard'
import OffstageJudgesFormModal from './OffstageJudgesFormModal'
import { OffstageManagementSummary } from '../-hooks/useOffstageManagementSummary'

const ITEMS_PER_PAGE = 24

export default function OffstageJudgesTab({
  categories,
  stages,
}: {
  ...
  const { data, isLoading, error } = useOffstageJudges({
    eventId,
    status,
    stageId,
    categoryId,
